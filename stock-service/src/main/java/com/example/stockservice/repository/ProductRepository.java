...
public interface ProductRepository extends JpaRepository<Product, String> {
    ...
    List<String> findIdsByCategoryName(@Param("categoryName") String categoryName);
    ...
    Page<Product> findByCategoryIdAndIdNotIn(String categoryId, List<String> excludedIds, Pageable pageable);
    ...
    Page<Product> findByUserIdAndIdNotInAndStatus(String userId, List<String> excludedIds, ProductStatus status,
            Pageable pageable);
}
